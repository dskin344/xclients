...
This document describes how to use pixi tasks. Pixi tasks provide a simple, cross-platform way to define and run common project commands.
...
[tasks.src-test]
cmd = "pytest tests/"
cwd = "src/repo"      # run from directory
```
